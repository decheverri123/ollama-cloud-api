...
const openApiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "A proxy service for the Ollama API that enriches Ollama Cloud models with live usage tiers (1=Low, 2=Medium, 3=High, 4=Extra High), scraped benchmarks, model recommendations, comparison, and leaderboards.",
  },
  servers: [
    {
