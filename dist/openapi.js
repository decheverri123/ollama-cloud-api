    ...
    paths: {
        "/api/show-cloud": {
            get: {
                ...
                description: "Lists all Ollama Cloud models live from Ollama's catalog, enriched with local installed status, direct ollama.com library link (ollama_url), parameters, template, capabilities, model_info, exact token pricing, and numeric usage tiers.",
                parameters: [
                    {
                        name: "model",
                        in: "query",
...
export function getOpenApiSpecWithHost(baseUrl) {
    return {
        ...openApiSpec,
        servers: [
            {
