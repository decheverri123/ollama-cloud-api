        ...
        if (pathname === "/api/chat" ||
            ...
            if (!ENABLE_COMPLETIONS) {
                return sendJson(res, 403, {
                    ...
                    message: "This API server provides cloud model discovery, usage tiers (1-4), recommendations, and benchmarks. Send inference requests directly to your own Ollama instance.",
