...
export const handleLeaderboard = withError(async (_req, res, parsedUrl) => {
    ...
    if (requestedCat) {
        const matchedKey = Object.keys(leaderboards).find((k) => k.toLowerCase() === requestedCat.toLowerCase());
